...
It might also be useful to know what fraction of the world population each country represented at each year.  Let's do that.
...
This gives a warning that values were removed (hidden in the knitted document), because we only have the data for the OECD countries.
